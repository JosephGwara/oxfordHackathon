...
contract AuctionRepository {
    ...
    // com.blockchainbulls.oxfordhackathon.models.Bid struct to hold bidder and amount
    struct Bid {
        address payable from;
        uint256 amount;
    }

    // com.blockchainbulls.oxfordhackathon.models.Auction struct which holds all the required info
    struct Auction {
        string name;
    ...
    * @dev com.blockchainbulls.oxfordhackathon.models.Auction should be active and not ended
